...
<html lang="en">
  ...
  <div class="container text-center">
        <h1>About</h1>
        <img src="Gambar/solongcoffee.jpg" style="width: 18rem;">
        <p class="font-weight-bold">Solong Mini Kopi adalah sebuah kedai yang sangat populer di daerah Banda Aceh. 
          Kedai ini menyediakan berbagai jenis kopi khas Aceh serta beberapa masakan khas Aceh. 
        </p>
      </div>
